...
document.addEventListener("DOMContentLoaded", () => {
        ...
        ayat.forEach((a, index) => {
          ...
          div.innerHTML = `
            <div class="flex justify-between items-center mb-2">
              ...
              <div>
                <button class="play-audio-btn text-primary-800 dark:text-primary-200 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200 mr-2" data-audio='${JSON.stringify(a.audio)}'>
    ...
    //     const audioSrc = JSON.parse(button.dataset.audio)[selectedQari];
    ...
    function playAyatAudio(button) {
        ...
        if (currentAudio && currentAudio.src === audioSrc) {
            ...
            if (currentAudio) {
                currentAudio.pause();
                const prevButton = document.querySelector('.play-audio-btn[data-playing="true"]');
                if (prevButton) {
                    prevButton.innerHTML = '<i class="fas fa-play"></i>';
